...
* [Capabilities: Terms describing capabilities of a service](Org.OData.Capabilities.V1.md) - [XML source](Org.OData.Capabilities.V1.xml) - [JSON source](Org.OData.Capabilities.V1.json)
