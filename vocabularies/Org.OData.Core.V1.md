...
[DoNotExpand](Org.OData.Core.V1.xml#L569)|EntityType?|<a name="DoNotExpand"></a>Entity-valued term that is never applied<br>Can be used in `$expand=@Core.DoNotExpand` to prevent automatic expansion of navigation properties. OData 4.02 or greater services SHOULD NOT return null for this annotation in the response.
