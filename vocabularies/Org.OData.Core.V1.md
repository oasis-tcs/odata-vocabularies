...
[Existed](./Org.OData.Core.V1.xml#L576:~:text=<EnumType%20Name="-,PreviousStateType,-")|1|The annotated entity describes changes to a resource that already existed prior to capturing these changes
[Unknown](./Org.OData.Core.V1.xml#L579:~:text=<EnumType%20Name="-,PreviousStateType,-")|0|The sender does not know whether the resource already existed prior to capturing these changes
