...
[ImplementsInterface](./Org.OData.Core.V1.xml#L571:~:text=<Term%20Name="-,ImplementsInterface,-")|String|<a name="ImplementsInterface"></a>The action or function implements the [interface](#IsInterface) action or function whose qualified name is the annotation value<br>This term can be applied to actions or functions as well as to properties or terms that identify an action or function.
