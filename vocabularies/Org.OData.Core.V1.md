...
[AutoExpandReferences](Org.OData.Core.V1.xml#L427)|[Tag](#Tag)|<a name="AutoExpandReferences"></a>The service will automatically expand this navigation property as entity references even if not requested with $expand=.../$ref
[MayImplement](Org.OData.Core.V1.xml#L431)|\[[QualifiedTypeName](#QualifiedTypeName)\]|<a name="MayImplement"></a>A collection of qualified type names outside of the type hierarchy that instances of this type might be addressable as by using a type-cast segment.
...
## <a name="ContentDispositionType"></a>[ContentDispositionType](Org.OData.Core.V1.xml#L408)
...
## <a name="QualifiedTypeName"></a>[QualifiedTypeName](Org.OData.Core.V1.xml#L439)
**Type:** String

The qualified name of a type in scope.

## <a name="TypeSpecification"></a>[TypeSpecification](Org.OData.Core.V1.xml#L443)
**Type:** String
