...
[RequiresExplicitBinding](Org.OData.Core.V1.xml#L523)|[Tag?](#Tag)|<a name="RequiresExplicitBinding"></a>This bound action or function is only available on model elements annotated with the ExplicitOperationBindings term or for instances where the operation is explicitly advertised in the payload.
...
[Subsets](Org.OData.Core.V1.xml#L581)|NavigationPropertyPath?|<a name="Subsets"></a>The annotated navigation property subsets the referenced navigation property.<br>Each entity reachable through the annotated navigation property is also reachable through the navigation property specified in the annotation. This term is inspired by the `subsets` UML constraint.
