...
[ImplementsSignature](./Org.OData.Core.V1.xml#L573:~:text=<Term%20Name="-,ImplementsSignature,-")|String|<a name="ImplementsSignature"></a>The action or function overload implements the action or function [signature](#IsSignature) whose qualified name is the annotation value<br>This term can be applied to actions or functions as well as to properties or terms that identify an action or function.
