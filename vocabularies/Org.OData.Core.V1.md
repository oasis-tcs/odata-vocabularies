...
[MediaType](./Org.OData.Core.V1.xml#L403:~:text=<Term%20Name="-,MediaType,-")|MediaType?|<a name="MediaType"></a>The media type of the values of a binary or string or stream property or term.<br>The annotation of a TypeDefinition propagates to the model elements having this type
...
[ContentDisposition](./Org.OData.Core.V1.xml#L414:~:text=<Term%20Name="-,ContentDisposition,-")|[ContentDispositionType](#ContentDispositionType)|<a name="ContentDisposition"></a>The content disposition of a media resource or a binary or stream property or term
...
## <a name="TypeSpecification"></a>[TypeSpecification](./Org.OData.Core.V1.xml#L456:~:text=<TypeDefinition%20Name="-,TypeSpecification,-")
**Type:** String
