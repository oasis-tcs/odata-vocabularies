...
[IncludeMetadata](Org.OData.Core.V1.xml#L306)|[MetadataKind](#MetadataKind)|<a name="IncludeMetadata"></a>Defines metadata that should automatically be returned in a response when the reply is qualified with `metadata=minimal`
[MayImplement](Org.OData.Core.V1.xml#L323)|\[[QualifiedTypeName](#QualifiedTypeName)\]|<a name="MayImplement"></a>A collection of qualified type names outside of the type hierarchy that instances of this type might be addressable as by using a type-cast segment.
[Ordered](Org.OData.Core.V1.xml#L332)|[Tag](#Tag)|<a name="Ordered"></a>Collection has a stable order. Ordered collections of primitive or complex types can be indexed by ordinal.
...
[AlternateKeys](Org.OData.Core.V1.xml#L341)|\[[AlternateKey](#AlternateKey)\]|<a name="AlternateKeys"></a>Communicates available alternate keys
...
## <a name="MetadataKind"></a>[MetadataKind](Org.OData.Core.V1.xml#L310)


Flag Member|Value|Description
:-----|----:|:----------
[count](Org.OData.Core.V1.xml#L311)|1|Return the number of related entities in `@count` (`@odata.count`) for collection-valued navigation properties
[navigationLink](Org.OData.Core.V1.xml#L315)|2|Return the navigation URL in `@navigationLink` (`@odata.navigationLink`)
[associationLink](Org.OData.Core.V1.xml#L318)|4|Return the association URL in `@associationLink ` (`@odata.associationLink `)

## <a name="QualifiedTypeName"></a>[QualifiedTypeName](Org.OData.Core.V1.xml#L328)
**Type:** String

The qualified name of a type in scope.

## <a name="AlternateKey"></a>[AlternateKey](Org.OData.Core.V1.xml#L344)


Property|Type|Description
:-------|:---|:----------
[Key](Org.OData.Core.V1.xml#L345)|\[[PropertyRef](#PropertyRef)\]|The set of properties that make up this key

## <a name="PropertyRef"></a>[PropertyRef](Org.OData.Core.V1.xml#L349)


Property|Type|Description
:-------|:---|:----------
[Name](Org.OData.Core.V1.xml#L350)|PropertyPath|A path expression resolving to a primitive property of the entity type itself or to a primitive property of a complex or navigation property (recursively) of the entity type. The names of the properties in the path are joined together by forward slashes.
[Alias](Org.OData.Core.V1.xml#L354)|String|A SimpleIdentifier that MUST be unique within the set of aliases, structural and navigation properties of the containing entity type that MUST be used in the key predicate of URLs

## <a name="Dictionary"></a>[Dictionary](Org.OData.Core.V1.xml#L360)
