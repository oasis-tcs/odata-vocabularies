...
[OpenPropertyTypeConstraint](./Org.OData.Validation.V1.xml#L143:~:text=Name="-,OpenPropertyTypeConstraint,-")|\[[TypeSpecification](Org.OData.Core.V1.md#TypeSpecification)\]|<a name="OpenPropertyTypeConstraint"></a>Dynamic properties added to the annotated open structured type are restricted to the listed types.
