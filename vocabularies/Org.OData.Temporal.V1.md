...
[DeleteObject](Org.OData.Temporal.V1.xml#L249)|timeslices:&nbsp;\[EntityType\], ObjectKey:&nbsp;EntityType, From:&nbsp;PrimitiveType, To:&nbsp;PrimitiveType &rarr;&nbsp;\[EntityType\]|<a name="DeleteObject"></a>Deletes all time slices of a temporal object in a given period of application time after splitting partially overlapping time slices
[DeleteObjectFrom](Org.OData.Temporal.V1.xml#L274)|timeslices:&nbsp;\[EntityType\], ObjectKey:&nbsp;EntityType, From:&nbsp;PrimitiveType, To:&nbsp;PrimitiveType &rarr;&nbsp;\[EntityType\]|<a name="DeleteObjectFrom"></a>Deletes time slices of a temporal object from a a given point in application time onwards and stops if a property changes its value from one time slice to the next
...
[ObjectKey](Org.OData.Temporal.V1.xml#L88)|\[PropertyPath\]|The set of primitive properties that identify a temporal object
