...
### <a name="Update"></a>[Update](./Org.OData.Temporal.V1.xml#L165:~:text=<Action%20Name="-,Update,-")
...
:--------|:---|:----------
**[timeslices](./Org.OData.Temporal.V1.xml#L173:~:text=<Action%20Name="-,Update,-")**|\[EntityType\]|**Binding parameter:** Time slices to modify
[deltaTimeslices](./Org.OData.Temporal.V1.xml#L176:~:text=<Action%20Name="-,Update,-")|\[[TimesliceWithPeriod](#TimesliceWithPeriod)\]|New time slices whose property values are used to update the `timeslices` collection<br>The delta time slices need not contain all properties, but at least the boundary values of the period to change. An absent object key property matches any key property value. New time slices are processed in the order of the collection, which especially matters if some of the specified change periods overlap.
[&rarr;](./Org.OData.Temporal.V1.xml#L184:~:text=<Action%20Name="-,Update,-")|\[EntityType\]|Modified time slices<br>Same entity type as binding parameter.


### <a name="Upsert"></a>[Upsert](./Org.OData.Temporal.V1.xml#L190:~:text=<Action%20Name="-,Upsert,-")

Like [`Update`](#Update), but additionally inserts those (sub-periods of) `deltaTimeslices` that `Update` disregards

Parameter|Type|Description
:--------|:---|:----------
**[timeslices](./Org.OData.Temporal.V1.xml#L192:~:text=<Action%20Name="-,Upsert,-")**|\[EntityType\]|**Binding parameter:** Time slices to modify
[deltaTimeslices](./Org.OData.Temporal.V1.xml#L195:~:text=<Action%20Name="-,Upsert,-")|\[[TimesliceWithPeriod](#TimesliceWithPeriod)\]|New time slices to be merged into the `timeslices` collection<br>The delta time slices must contain all properties that are needed for insertion. New time slices are processed in the order of the collection, which especially matters if some of the specified change periods overlap.
[&rarr;](./Org.OData.Temporal.V1.xml#L202:~:text=<Action%20Name="-,Upsert,-")|\[EntityType\]|Modified time slices<br>Same entity type as binding parameter.


### <a name="UpdateFrom"></a>[UpdateFrom](./Org.OData.Temporal.V1.xml#L208:~:text=<Action%20Name="-,UpdateFrom,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[timeslices](./Org.OData.Temporal.V1.xml#L210:~:text=<Action%20Name="-,UpdateFrom,-")**|\[EntityType\]|**Binding parameter:** Time slices to modify
[deltaTimeslices](./Org.OData.Temporal.V1.xml#L213:~:text=<Action%20Name="-,UpdateFrom,-")|\[[TimesliceWithPeriod](#TimesliceWithPeriod)\]|New time slices whose property values are used to update the `timeslices` collection<br>The delta time slices need not contain all properties, but at least the lower boundary of the period to change. An absent object key property matches any key property value. New time slices are processed in the order of the collection, which especially matters if some of the specified change periods overlap.
[&rarr;](./Org.OData.Temporal.V1.xml#L221:~:text=<Action%20Name="-,UpdateFrom,-")|\[EntityType\]|Modified time slices<br>Same entity type as binding parameter.


### <a name="Delete"></a>[Delete](./Org.OData.Temporal.V1.xml#L227:~:text=<Action%20Name="-,Delete,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[timeslices](./Org.OData.Temporal.V1.xml#L235:~:text=<Action%20Name="-,Delete,-")**|\[EntityType\]|**Binding parameter:** Time slices to modify
[deltaTimeslices](./Org.OData.Temporal.V1.xml#L238:~:text=<Action%20Name="-,Delete,-")|\[[TimesliceWithPeriod](#TimesliceWithPeriod)\]|Time slices to be deleted from the `timeslices` collection<br>The delta time slices contain only the boundary values of the period to delete and (parts of) the object key. An absent object key property matches any key property value.
[&rarr;](./Org.OData.Temporal.V1.xml#L245:~:text=<Action%20Name="-,Delete,-")|\[EntityType\]|Deleted (sub-periods of) time slices<br>Same entity type as binding parameter.


### <a name="DeleteFrom"></a>[DeleteFrom](./Org.OData.Temporal.V1.xml#L251:~:text=<Action%20Name="-,DeleteFrom,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[timeslices](./Org.OData.Temporal.V1.xml#L253:~:text=<Action%20Name="-,DeleteFrom,-")**|\[EntityType\]|**Binding parameter:** Time slices to modify
[deltaTimeslices](./Org.OData.Temporal.V1.xml#L256:~:text=<Action%20Name="-,DeleteFrom,-")|\[[TimesliceWithPeriod](#TimesliceWithPeriod)\]|Time slices to be deleted from the `timeslices` collection<br>The delta time slices contain only the lower and optionally upper boundary values of the period to delete and (parts of) the object key. An absent object key property matches any key property value.
[&rarr;](./Org.OData.Temporal.V1.xml#L263:~:text=<Action%20Name="-,DeleteFrom,-")|\[EntityType\]|Deleted time slices<br>Same entity type as binding parameter.
...
Property|Type|Description
:-------|:---|:----------
[Timeslice](./Org.OData.Temporal.V1.xml#L152:~:text=<ComplexType%20Name="-,TimesliceWithPeriod,-")|EntityType|A time slice with the same entity type as the binding parameter of the action
