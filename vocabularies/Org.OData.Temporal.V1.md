...
[History](Org.OData.Temporal.V1.xml#L145)|\[EntityType\]|<a name="History"></a>A collection of time slices representing the history of the annotated entity <p>The time slices have the same entity type as the annotated entity and use the same select-expand projection.</p>
...
[ObjectKey](Org.OData.Temporal.V1.xml#L158)|EntityType|Property values that identify a single temporal object <p>Select-expand projection of the same entity type as binding parameter, containing all and only properties reference in the [`ObjectKey`](#ObjectKey) of that entity type.</p>
...
[Values](Org.OData.Temporal.V1.xml#L168)|EntityType|Property values to update <p>Same entity type as binding parameter and return type, specify only values of non-key properties.</p>
...
[ObjectKey](Org.OData.Temporal.V1.xml#L183)|EntityType|Property values that identify a single temporal object <p>Select-expand projection of the same entity type as binding parameter, containing all and only properties reference in the [`ObjectKey`](#ObjectKey) of that entity type.</p>
...
[Values](Org.OData.Temporal.V1.xml#L193)|EntityType|Property values to insert or update <p>Same entity type as binding parameter and return type, specify only values of non-key properties.</p>
&rarr;|\[EntityType\]|Modified time slices <p>Same entity type as binding parameter.</p>
...
[ObjectKey](Org.OData.Temporal.V1.xml#L208)|EntityType|Property values that identify a single temporal object <p>Select-expand projection of the same entity type as binding parameter, containing all and only properties reference in the [`ObjectKey`](#ObjectKey) of that entity type.</p>
...
[Values](Org.OData.Temporal.V1.xml#L218)|EntityType|Property values to update <p>Same entity type as binding parameter and return type, specify only values of non-key properties.</p>
&rarr;|\[EntityType\]|Modified time slices <p>Same entity type as binding parameter.</p>
...
[ObjectKey](Org.OData.Temporal.V1.xml#L233)|EntityType|Property values that identify a single temporal object <p>Select-expand projection of the same entity type as binding parameter, containing all and only properties reference in the [`ObjectKey`](#ObjectKey) of that entity type.</p>
[Timeline](Org.OData.Temporal.V1.xml#L237)|\[EntityType\]|List of time slices covering the full timeline of the temporal object <p>Same entity type as the binding parameter.</p>
...
[ObjectKey](Org.OData.Temporal.V1.xml#L248)|EntityType|Property values that identify a single temporal object <p>Select-expand projection of the same entity type as binding parameter, containing all and only properties reference in the [`ObjectKey`](#ObjectKey) of that entity type.</p>
...
[ObjectKey](Org.OData.Temporal.V1.xml#L269)|EntityType|Property values that identify a single temporal object <p>Select-expand projection of the same entity type as binding parameter, containing all and only properties reference in the [`ObjectKey`](#ObjectKey) of that entity type.</p>
...
:-------|:---|:----------
[*SupportedQueries*](Org.OData.Temporal.V1.xml#L95)|[QueryType](#QueryType)|
[ClosedClosedPeriods](Org.OData.Temporal.V1.xml#L112)|Boolean|Application-time periods are stored with closed-closed semantics <p>Use the temporal query option `$toInclusive` instead of `$to` for specifying the period end in time-series queries.</p>
