...
[JsonStreamingSupport](Org.OData.Capabilities.V1.xml#L159)|[JsonStreamingSupportType?](#JsonStreamingSupportType)|<a name="JsonStreamingSupport"></a>Services support for JSON Payload Ordering Constraints
[SupportedMetadataFormats](Org.OData.Capabilities.V1.xml#L175)|\[MediaType\]|<a name="SupportedMetadataFormats"></a>Media types of supported formats for $metadata, including format parameters
[AcceptableEncodings](Org.OData.Capabilities.V1.xml#L180)|\[String\]|<a name="AcceptableEncodings"></a>List of acceptable compression methods for ($batch) requests, e.g. gzip
...
## [JsonStreamingSupportType](Org.OData.Capabilities.V1.xml#L163)


Flag Member|Value|Description
:-----|----:|:----------
[StreamingSupported](Org.OData.Capabilities.V1.xml#L164)|1|Service supports the application/json media type with the odata.streaming=true format parameter
[AlwaysOrdered](Org.OData.Capabilities.V1.xml#L167)|2|JSON Responses always comply with the Payload Ordering Constraints
[OrderingRequired](Org.OData.Capabilities.V1.xml#L170)|4|JSON Requests must comply with the Payload Ordering Constraints
