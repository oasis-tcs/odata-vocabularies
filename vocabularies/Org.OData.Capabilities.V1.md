...
Using a property of this complex type in a [`NavigationRestrictions`](#NavigationRestrictions) annotation
          is deprecated in favor of using an annotation with the eponymous term and a target path ending in the `NavigationProperty`,
