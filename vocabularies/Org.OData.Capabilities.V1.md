...
[InsertRestrictions](Org.OData.Capabilities.V1.xml#L576) *([AppliesToTypeIfDynamic](Org.OData.Core.V1.md#AppliesToTypeIfDynamic))*|[InsertRestrictionsType](#InsertRestrictionsType)|<a name="InsertRestrictions"></a>Restrictions on insert operations
...
[UpdateRestrictions](Org.OData.Capabilities.V1.xml#L662) *([AppliesToTypeIfDynamic](Org.OData.Core.V1.md#AppliesToTypeIfDynamic))*|[UpdateRestrictionsType](#UpdateRestrictionsType)|<a name="UpdateRestrictions"></a>Restrictions on update operations
...
[DeleteRestrictions](Org.OData.Capabilities.V1.xml#L755) *([AppliesToTypeIfDynamic](Org.OData.Core.V1.md#AppliesToTypeIfDynamic))*|[DeleteRestrictionsType](#DeleteRestrictionsType)|<a name="DeleteRestrictions"></a>Restrictions on delete operations
