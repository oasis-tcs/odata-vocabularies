...
### <a name="isroot"></a>[isroot](Org.OData.Aggregation.V1.xml#L197)

Returns true, if and only if the value of the node property of the specified hierarchy is the root of the hierarchy

Parameter|Type|Description
:--------|:---|:----------
**[Entity](Org.OData.Aggregation.V1.xml#L199)**|EntityType|**Binding parameter**
[Hierarchy](Org.OData.Aggregation.V1.xml#L200)|String|
[&rarr;](Org.OData.Aggregation.V1.xml#L201)|Boolean|


### <a name="isdescendant"></a>[isdescendant](Org.OData.Aggregation.V1.xml#L204)
...
[Node](Org.OData.Aggregation.V1.xml#L208)|PrimitiveType|
[MaxDistance](Org.OData.Aggregation.V1.xml#L209)|Int16?|
[&rarr;](Org.OData.Aggregation.V1.xml#L210)|Boolean|


### <a name="isancestor"></a>[isancestor](Org.OData.Aggregation.V1.xml#L213)
...
[Node](Org.OData.Aggregation.V1.xml#L217)|PrimitiveType|
[MaxDistance](Org.OData.Aggregation.V1.xml#L218)|Int16?|
[&rarr;](Org.OData.Aggregation.V1.xml#L219)|Boolean|


### <a name="issibling"></a>[issibling](Org.OData.Aggregation.V1.xml#L222)
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](Org.OData.Aggregation.V1.xml#L224)**|EntityType|**Binding parameter**
[Hierarchy](Org.OData.Aggregation.V1.xml#L225)|String|
[Node](Org.OData.Aggregation.V1.xml#L226)|PrimitiveType|
[&rarr;](Org.OData.Aggregation.V1.xml#L227)|Boolean|


### <a name="isleaf"></a>[isleaf](Org.OData.Aggregation.V1.xml#L230)
...
[ParentNavigationProperty](Org.OData.Aggregation.V1.xml#L192)|NavigationPropertyPath|Property for navigating to the parent node. Its type MUST be the entity type annotated with this term, and it MUST be nullable.

## <a name="AvailableOnAggregatesType"></a>[AvailableOnAggregatesType](Org.OData.Aggregation.V1.xml#L240)


Property|Type|Description
:-------|:---|:----------
[RequiredProperties](Org.OData.Aggregation.V1.xml#L241)|\[PropertyPath\]|Properties required to apply this action or function

## <a name="NavigationPropertyAggregationCapabilities"></a>[NavigationPropertyAggregationCapabilities](Org.OData.Aggregation.V1.xml#L246): [NavigationPropertyRestriction](Org.OData.Capabilities.V1.md#NavigationPropertyRestriction) *(Deprecated)*
...
## <a name="CustomAggregateType"></a>[CustomAggregateType](Org.OData.Aggregation.V1.xml#L264) *(Deprecated)*
