...
[AvailableOnAggregates](./Org.OData.Aggregation.V1.xml#L237:~:text=Name="-,AvailableOnAggregates,-")|[AvailableOnAggregatesType](#AvailableOnAggregatesType)|<a name="AvailableOnAggregates"></a>This action or function is available on aggregated entities if the `RequiredProperties` are still defined


## Functions

### <a name="isroot"></a>[isroot](./Org.OData.Aggregation.V1.xml#L197:~:text=Name="-,isroot,-")

Returns true, if and only if the value of the node property of the specified hierarchy is the root of the hierarchy

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L199:~:text=Name="-,Entity,-")**|EntityType|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L200:~:text=Name="-,Hierarchy,-")|String|
[&rarr;](./Org.OData.Aggregation.V1.xml#L201:~:text=Name="-,&rarr;,-")|Boolean|


### <a name="isdescendant"></a>[isdescendant](./Org.OData.Aggregation.V1.xml#L204:~:text=Name="-,isdescendant,-")
...
[Node](./Org.OData.Aggregation.V1.xml#L208:~:text=Name="-,Node,-")|PrimitiveType|
[MaxDistance](./Org.OData.Aggregation.V1.xml#L209:~:text=Name="-,MaxDistance,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L210:~:text=Name="-,&rarr;,-")|Boolean|


### <a name="isancestor"></a>[isancestor](./Org.OData.Aggregation.V1.xml#L213:~:text=Name="-,isancestor,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L215:~:text=Name="-,Entity,-")**|EntityType|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L216:~:text=Name="-,Hierarchy,-")|String|
[Node](./Org.OData.Aggregation.V1.xml#L217:~:text=Name="-,Node,-")|PrimitiveType|
[MaxDistance](./Org.OData.Aggregation.V1.xml#L218:~:text=Name="-,MaxDistance,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L219:~:text=Name="-,&rarr;,-")|Boolean|


### <a name="issibling"></a>[issibling](./Org.OData.Aggregation.V1.xml#L222:~:text=Name="-,issibling,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L224:~:text=Name="-,Entity,-")**|EntityType|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L225:~:text=Name="-,Hierarchy,-")|String|
[Node](./Org.OData.Aggregation.V1.xml#L226:~:text=Name="-,Node,-")|PrimitiveType|
[&rarr;](./Org.OData.Aggregation.V1.xml#L227:~:text=Name="-,&rarr;,-")|Boolean|


### <a name="isleaf"></a>[isleaf](./Org.OData.Aggregation.V1.xml#L230:~:text=Name="-,isleaf,-")
...
[ParentNavigationProperty](./Org.OData.Aggregation.V1.xml#L192:~:text=Name="-,ParentNavigationProperty,-")|NavigationPropertyPath|Property for navigating to the parent node. Its type MUST be the entity type annotated with this term, and it MUST be nullable.

## <a name="AvailableOnAggregatesType"></a>[AvailableOnAggregatesType](./Org.OData.Aggregation.V1.xml#L240:~:text=Name="-,AvailableOnAggregatesType,-")


Property|Type|Description
:-------|:---|:----------
[RequiredProperties](./Org.OData.Aggregation.V1.xml#L241:~:text=Name="-,RequiredProperties,-")|\[PropertyPath\]|Properties required to apply this action or function

## <a name="NavigationPropertyAggregationCapabilities"></a>[NavigationPropertyAggregationCapabilities](./Org.OData.Aggregation.V1.xml#L246:~:text=Name="-,NavigationPropertyAggregationCapabilities,-"): [NavigationPropertyRestriction](Org.OData.Capabilities.V1.md#NavigationPropertyRestriction) *(Deprecated)*
...
## <a name="CustomAggregateType"></a>[CustomAggregateType](./Org.OData.Aggregation.V1.xml#L264:~:text=Name="-,CustomAggregateType,-") *(Deprecated)*
