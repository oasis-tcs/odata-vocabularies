...
[AvailableOnAggregates](./Org.OData.Aggregation.V1.xml#L271:~:text=Name="-,AvailableOnAggregates,-")|[AvailableOnAggregatesType](#AvailableOnAggregatesType)|<a name="AvailableOnAggregates"></a>This action or function is available on aggregated entities if the `RequiredProperties` are still defined


## Functions

### <a name="isroot"></a>[isroot](./Org.OData.Aggregation.V1.xml#L220:~:text=Name="-,isroot,-")

Is the entity the root of the specified hierarchy?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L222:~:text=Name="-,Entity,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L223:~:text=Name="-,Nodes,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L224:~:text=Name="-,Hierarchy,-")|[HierarchyQualifier](#HierarchyQualifier)|
[&rarr;](./Org.OData.Aggregation.V1.xml#L225:~:text=Name="-,&rarr;,-")|Boolean|


### <a name="isdescendant"></a>[isdescendant](./Org.OData.Aggregation.V1.xml#L228:~:text=Name="-,isdescendant,-")
...
[Nodes](./Org.OData.Aggregation.V1.xml#L231:~:text=Name="-,Nodes,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L232:~:text=Name="-,Hierarchy,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L233:~:text=Name="-,Node,-")|PrimitiveType|Parent node
[MaxDistance](./Org.OData.Aggregation.V1.xml#L236:~:text=Name="-,MaxDistance,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L237:~:text=Name="-,&rarr;,-")|Boolean|


### <a name="isancestor"></a>[isancestor](./Org.OData.Aggregation.V1.xml#L240:~:text=Name="-,isancestor,-")
...
[Nodes](./Org.OData.Aggregation.V1.xml#L243:~:text=Name="-,Nodes,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L244:~:text=Name="-,Hierarchy,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L245:~:text=Name="-,Node,-")|PrimitiveType|Child node
[MaxDistance](./Org.OData.Aggregation.V1.xml#L248:~:text=Name="-,MaxDistance,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L249:~:text=Name="-,&rarr;,-")|Boolean|


### <a name="issibling"></a>[issibling](./Org.OData.Aggregation.V1.xml#L252:~:text=Name="-,issibling,-")

Does the entity have the same parent node in the specified hierarchy as the sibling node?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L254:~:text=Name="-,Entity,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L255:~:text=Name="-,Nodes,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L256:~:text=Name="-,Hierarchy,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L257:~:text=Name="-,Node,-")|PrimitiveType|Sibling node
...
[Nodes](./Org.OData.Aggregation.V1.xml#L266:~:text=Name="-,Nodes,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L267:~:text=Name="-,Hierarchy,-")|[HierarchyQualifier](#HierarchyQualifier)|
[&rarr;](./Org.OData.Aggregation.V1.xml#L268:~:text=Name="-,&rarr;,-")|Boolean|
...
## <a name="HierarchyEntitySet"></a>[HierarchyEntitySet](./Org.OData.Aggregation.V1.xml#L204:~:text=Name="-,HierarchyEntitySet,-")
**Type:** String
...
## <a name="HierarchyQualifier"></a>[HierarchyQualifier](./Org.OData.Aggregation.V1.xml#L212:~:text=Name="-,HierarchyQualifier,-")
**Type:** String
...
## <a name="AvailableOnAggregatesType"></a>[AvailableOnAggregatesType](./Org.OData.Aggregation.V1.xml#L274:~:text=Name="-,AvailableOnAggregatesType,-")


Property|Type|Description
:-------|:---|:----------
[RequiredProperties](./Org.OData.Aggregation.V1.xml#L275:~:text=Name="-,RequiredProperties,-")|\[PropertyPath\]|Properties required to apply this action or function

## <a name="NavigationPropertyAggregationCapabilities"></a>[NavigationPropertyAggregationCapabilities](./Org.OData.Aggregation.V1.xml#L280:~:text=Name="-,NavigationPropertyAggregationCapabilities,-"): [NavigationPropertyRestriction](Org.OData.Capabilities.V1.md#NavigationPropertyRestriction) *(Deprecated)*
...
## <a name="CustomAggregateType"></a>[CustomAggregateType](./Org.OData.Aggregation.V1.xml#L298:~:text=Name="-,CustomAggregateType,-") *(Deprecated)*
