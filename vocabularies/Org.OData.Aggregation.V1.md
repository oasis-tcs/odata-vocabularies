...
[AvailableOnAggregates](./Org.OData.Aggregation.V1.xml#L281:~:text=<Term%20Name="-,AvailableOnAggregates,-")|[AvailableOnAggregatesType](#AvailableOnAggregatesType)|<a name="AvailableOnAggregates"></a>This action or function is available on aggregated entities if the `RequiredProperties` are still defined
...
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L232:~:text=<Function%20Name="-,isroot,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L233:~:text=<Function%20Name="-,isroot,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L234:~:text=<Function%20Name="-,isroot,-")|[HierarchyQualifier](#HierarchyQualifier)|
[&rarr;](./Org.OData.Aggregation.V1.xml#L235:~:text=<Function%20Name="-,isroot,-")|Boolean|


### <a name="isdescendant"></a>[isdescendant](./Org.OData.Aggregation.V1.xml#L238:~:text=<Function%20Name="-,isdescendant,-")

Is the entity a descendant in the specified hierarchy of the parent node, optionally with at most the specified distance?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L240:~:text=<Function%20Name="-,isdescendant,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L241:~:text=<Function%20Name="-,isdescendant,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L242:~:text=<Function%20Name="-,isdescendant,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L243:~:text=<Function%20Name="-,isdescendant,-")|PrimitiveType|Parent node
[MaxDistance](./Org.OData.Aggregation.V1.xml#L246:~:text=<Function%20Name="-,isdescendant,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L247:~:text=<Function%20Name="-,isdescendant,-")|Boolean|


### <a name="isancestor"></a>[isancestor](./Org.OData.Aggregation.V1.xml#L250:~:text=<Function%20Name="-,isancestor,-")

Is the entity an ancestor in the specified hierarchy of the child node, optionally with at most the specified distance?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L252:~:text=<Function%20Name="-,isancestor,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L253:~:text=<Function%20Name="-,isancestor,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L254:~:text=<Function%20Name="-,isancestor,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L255:~:text=<Function%20Name="-,isancestor,-")|PrimitiveType|Child node
[MaxDistance](./Org.OData.Aggregation.V1.xml#L258:~:text=<Function%20Name="-,isancestor,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L259:~:text=<Function%20Name="-,isancestor,-")|Boolean|


### <a name="issibling"></a>[issibling](./Org.OData.Aggregation.V1.xml#L262:~:text=<Function%20Name="-,issibling,-")

Does the entity have the same parent node in the specified hierarchy as the sibling node?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L264:~:text=<Function%20Name="-,issibling,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L265:~:text=<Function%20Name="-,issibling,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L266:~:text=<Function%20Name="-,issibling,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L267:~:text=<Function%20Name="-,issibling,-")|PrimitiveType|Sibling node
...
[Nodes](./Org.OData.Aggregation.V1.xml#L276:~:text=<Function%20Name="-,isleaf,-")|[HierarchyEntitySet?](#HierarchyEntitySet)|
[Hierarchy](./Org.OData.Aggregation.V1.xml#L277:~:text=<Function%20Name="-,isleaf,-")|[HierarchyQualifier](#HierarchyQualifier)|
[&rarr;](./Org.OData.Aggregation.V1.xml#L278:~:text=<Function%20Name="-,isleaf,-")|Boolean|
...
Name of the entity set containing the nodes of the recursive hierarchy
...
## <a name="AvailableOnAggregatesType"></a>[AvailableOnAggregatesType](./Org.OData.Aggregation.V1.xml#L284:~:text=<ComplexType%20Name="-,AvailableOnAggregatesType,-")


Property|Type|Description
:-------|:---|:----------
[RequiredProperties](./Org.OData.Aggregation.V1.xml#L285:~:text=<ComplexType%20Name="-,AvailableOnAggregatesType,-")|\[PropertyPath\]|Properties required to apply this action or function

## <a name="NavigationPropertyAggregationCapabilities"></a>[NavigationPropertyAggregationCapabilities](./Org.OData.Aggregation.V1.xml#L290:~:text=<ComplexType%20Name="-,NavigationPropertyAggregationCapabilities,-"): [NavigationPropertyRestriction](Org.OData.Capabilities.V1.md#NavigationPropertyRestriction) *(Deprecated)*
...
## <a name="CustomAggregateType"></a>[CustomAggregateType](./Org.OData.Aggregation.V1.xml#L308:~:text=<ComplexType%20Name="-,CustomAggregateType,-") *(Deprecated)*
