...
[AvailableOnAggregates](Org.OData.Aggregation.V1.xml#L247)|[AvailableOnAggregatesType](#AvailableOnAggregatesType)|<a name="AvailableOnAggregates"></a>This action or function is available on aggregated entities if the `RequiredProperties` are still defined
...
[MaxDistance](Org.OData.Aggregation.V1.xml#L219)|Int16?|
[&rarr;](Org.OData.Aggregation.V1.xml#L220)|Boolean|


### <a name="isancestor"></a>[isancestor](Org.OData.Aggregation.V1.xml#L223)
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](Org.OData.Aggregation.V1.xml#L225)**|EntityType|**Binding parameter**
[Hierarchy](Org.OData.Aggregation.V1.xml#L226)|String|
[Node](Org.OData.Aggregation.V1.xml#L227)|PrimitiveType|
[MaxDistance](Org.OData.Aggregation.V1.xml#L228)|Int16?|
[&rarr;](Org.OData.Aggregation.V1.xml#L229)|Boolean|


### <a name="issibling"></a>[issibling](Org.OData.Aggregation.V1.xml#L232)
...
### <a name="isleaf"></a>[isleaf](Org.OData.Aggregation.V1.xml#L240)
...
## <a name="AvailableOnAggregatesType"></a>[AvailableOnAggregatesType](Org.OData.Aggregation.V1.xml#L250)


Property|Type|Description
:-------|:---|:----------
[RequiredProperties](Org.OData.Aggregation.V1.xml#L251)|\[PropertyPath\]|Properties required to apply this action or function

## <a name="NavigationPropertyAggregationCapabilities"></a>[NavigationPropertyAggregationCapabilities](Org.OData.Aggregation.V1.xml#L256): [NavigationPropertyRestriction](Org.OData.Capabilities.V1.md#NavigationPropertyRestriction) *(Deprecated)*
...
## <a name="CustomAggregateType"></a>[CustomAggregateType](Org.OData.Aggregation.V1.xml#L274) *(Deprecated)*
