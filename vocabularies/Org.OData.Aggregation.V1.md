...
[rolledup](./Org.OData.Aggregation.V1.xml#L192:~:text=<Term%20Name="-,rolledup,-")|[Tag](Org.OData.Core.V1.md#Tag)|<a name="rolledup"></a>This instance annotation occurs in the output set of a `groupby` transformation with `rollup` to identify a property that has been aggregated away<br>Servers SHOULD NOT include this instance annotation in the response unless it requested with `$select`. See [this example](../examples/Org.OData.Aggregation.V1.rollup.md).
