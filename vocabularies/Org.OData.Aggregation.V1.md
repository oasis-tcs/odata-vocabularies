...
[AvailableOnAggregates](./Org.OData.Aggregation.V1.xml#L286:~:text=<Term%20Name="-,AvailableOnAggregates,-")|[AvailableOnAggregatesType](#AvailableOnAggregatesType)|<a name="AvailableOnAggregates"></a>This action or function is available on aggregated entities if the `RequiredProperties` are still defined
...
[Nodes](./Org.OData.Aggregation.V1.xml#L218:~:text=<Function%20Name="-,isroot,-")|String|Name of the entity set holding the nodes of the recursive hierarchy
[Hierarchy](./Org.OData.Aggregation.V1.xml#L221:~:text=<Function%20Name="-,isroot,-")|String|Qualifier to identify the `RecursiveHierarchy` annotation applied to the type of the entity set referenced in `Nodes`
[&rarr;](./Org.OData.Aggregation.V1.xml#L224:~:text=<Function%20Name="-,isroot,-")|Boolean|


### <a name="isdescendant"></a>[isdescendant](./Org.OData.Aggregation.V1.xml#L227:~:text=<Function%20Name="-,isdescendant,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L229:~:text=<Function%20Name="-,isdescendant,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L230:~:text=<Function%20Name="-,isdescendant,-")|String|Name of the entity set holding the nodes of the recursive hierarchy
[Hierarchy](./Org.OData.Aggregation.V1.xml#L233:~:text=<Function%20Name="-,isdescendant,-")|String|Qualifier to identify the `RecursiveHierarchy` annotation applied to the type of the entity set referenced in `Nodes`
[Node](./Org.OData.Aggregation.V1.xml#L236:~:text=<Function%20Name="-,isdescendant,-")|PrimitiveType|Parent node value
...
[Nodes](./Org.OData.Aggregation.V1.xml#L246:~:text=<Function%20Name="-,isancestor,-")|String|Name of the entity set holding the nodes of the recursive hierarchy
[Hierarchy](./Org.OData.Aggregation.V1.xml#L249:~:text=<Function%20Name="-,isancestor,-")|String|Qualifier to identify the `RecursiveHierarchy` annotation applied to the type of the entity set referenced in `Nodes`
[Node](./Org.OData.Aggregation.V1.xml#L252:~:text=<Function%20Name="-,isancestor,-")|PrimitiveType|Child node value
[MaxDistance](./Org.OData.Aggregation.V1.xml#L255:~:text=<Function%20Name="-,isancestor,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L256:~:text=<Function%20Name="-,isancestor,-")|Boolean|


### <a name="issibling"></a>[issibling](./Org.OData.Aggregation.V1.xml#L259:~:text=<Function%20Name="-,issibling,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L261:~:text=<Function%20Name="-,issibling,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L262:~:text=<Function%20Name="-,issibling,-")|String|Name of the entity set holding the nodes of the recursive hierarchy
[Hierarchy](./Org.OData.Aggregation.V1.xml#L265:~:text=<Function%20Name="-,issibling,-")|String|Qualifier to identify the `RecursiveHierarchy` annotation applied to the type of the entity set referenced in `Nodes`
[Node](./Org.OData.Aggregation.V1.xml#L268:~:text=<Function%20Name="-,issibling,-")|PrimitiveType|Sibling node value
[&rarr;](./Org.OData.Aggregation.V1.xml#L271:~:text=<Function%20Name="-,issibling,-")|Boolean|


### <a name="isleaf"></a>[isleaf](./Org.OData.Aggregation.V1.xml#L274:~:text=<Function%20Name="-,isleaf,-")
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L276:~:text=<Function%20Name="-,isleaf,-")**|EntityType|**Binding parameter**
[Nodes](./Org.OData.Aggregation.V1.xml#L277:~:text=<Function%20Name="-,isleaf,-")|String|Name of the entity set holding the nodes of the recursive hierarchy
[Hierarchy](./Org.OData.Aggregation.V1.xml#L280:~:text=<Function%20Name="-,isleaf,-")|String|Qualifier to identify the `RecursiveHierarchy` annotation applied to the type of the entity set referenced in `Nodes`
[&rarr;](./Org.OData.Aggregation.V1.xml#L283:~:text=<Function%20Name="-,isleaf,-")|Boolean|
...
## <a name="AvailableOnAggregatesType"></a>[AvailableOnAggregatesType](./Org.OData.Aggregation.V1.xml#L289:~:text=<ComplexType%20Name="-,AvailableOnAggregatesType,-")


Property|Type|Description
:-------|:---|:----------
[RequiredProperties](./Org.OData.Aggregation.V1.xml#L290:~:text=<ComplexType%20Name="-,AvailableOnAggregatesType,-")|\[PropertyPath\]|Properties required to apply this action or function

## <a name="NavigationPropertyAggregationCapabilities"></a>[NavigationPropertyAggregationCapabilities](./Org.OData.Aggregation.V1.xml#L295:~:text=<ComplexType%20Name="-,NavigationPropertyAggregationCapabilities,-"): [NavigationPropertyRestriction](Org.OData.Capabilities.V1.md#NavigationPropertyRestriction) *(Deprecated)*
...
## <a name="CustomAggregateType"></a>[CustomAggregateType](./Org.OData.Aggregation.V1.xml#L313:~:text=<ComplexType%20Name="-,CustomAggregateType,-") *(Deprecated)*
