...
[AvailableOnAggregates](./Org.OData.Aggregation.V1.xml#L312:~:text=<Term%20Name="-,AvailableOnAggregates,-")|[AvailableOnAggregatesType](#AvailableOnAggregatesType)|<a name="AvailableOnAggregates"></a>This action or function is available on aggregated entities if the `RequiredProperties` are still defined


## Functions

### <a name="switch"></a>[switch](./Org.OData.Aggregation.V1.xml#L227:~:text=<Function%20Name="-,switch,-")
...
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L240:~:text=<Function%20Name="-,switch,-")**|EntityType?|**Binding parameter**
[EntitySet](./Org.OData.Aggregation.V1.xml#L241:~:text=<Function%20Name="-,switch,-")|\[EntityType\]|A named or implicit entity set, specified with a path expression
[&rarr;](./Org.OData.Aggregation.V1.xml#L244:~:text=<Function%20Name="-,switch,-")|EntityType?|


### <a name="switch"></a>[switch](./Org.OData.Aggregation.V1.xml#L246)
...
Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L259)**|\[EntityType\]|**Binding parameter**
[EntitySet](./Org.OData.Aggregation.V1.xml#L260)|\[EntityType\]|A named or implicit entity set, specified with a path expression
[&rarr;](./Org.OData.Aggregation.V1.xml#L263)|\[EntityType\]|


### <a name="isroot"></a>[isroot](./Org.OData.Aggregation.V1.xml#L266:~:text=<Function%20Name="-,isroot,-")

Is the entity the root of the specified hierarchy?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L268:~:text=<Function%20Name="-,isroot,-")**|EntityType?|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L269:~:text=<Function%20Name="-,isroot,-")|[HierarchyQualifier](#HierarchyQualifier)|
[&rarr;](./Org.OData.Aggregation.V1.xml#L270:~:text=<Function%20Name="-,isroot,-")|Boolean?|


### <a name="isdescendant"></a>[isdescendant](./Org.OData.Aggregation.V1.xml#L273:~:text=<Function%20Name="-,isdescendant,-")

Is the entity a descendant in the specified hierarchy of the parent node, optionally with at most the specified distance?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L275:~:text=<Function%20Name="-,isdescendant,-")**|EntityType?|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L276:~:text=<Function%20Name="-,isdescendant,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L277:~:text=<Function%20Name="-,isdescendant,-")|PrimitiveType|Parent node
[MaxDistance](./Org.OData.Aggregation.V1.xml#L280:~:text=<Function%20Name="-,isdescendant,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L281:~:text=<Function%20Name="-,isdescendant,-")|Boolean?|


### <a name="isancestor"></a>[isancestor](./Org.OData.Aggregation.V1.xml#L284:~:text=<Function%20Name="-,isancestor,-")

Is the entity an ancestor in the specified hierarchy of the child node, optionally with at most the specified distance?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L286:~:text=<Function%20Name="-,isancestor,-")**|EntityType?|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L287:~:text=<Function%20Name="-,isancestor,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L288:~:text=<Function%20Name="-,isancestor,-")|PrimitiveType|Child node
[MaxDistance](./Org.OData.Aggregation.V1.xml#L291:~:text=<Function%20Name="-,isancestor,-")|Int16?|
[&rarr;](./Org.OData.Aggregation.V1.xml#L292:~:text=<Function%20Name="-,isancestor,-")|Boolean?|


### <a name="issibling"></a>[issibling](./Org.OData.Aggregation.V1.xml#L295:~:text=<Function%20Name="-,issibling,-")

Does the entity have the same parent node in the specified hierarchy as the sibling node?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L297:~:text=<Function%20Name="-,issibling,-")**|EntityType?|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L298:~:text=<Function%20Name="-,issibling,-")|[HierarchyQualifier](#HierarchyQualifier)|
[Node](./Org.OData.Aggregation.V1.xml#L299:~:text=<Function%20Name="-,issibling,-")|PrimitiveType|Sibling node
[&rarr;](./Org.OData.Aggregation.V1.xml#L302:~:text=<Function%20Name="-,issibling,-")|Boolean?|


### <a name="isleaf"></a>[isleaf](./Org.OData.Aggregation.V1.xml#L305:~:text=<Function%20Name="-,isleaf,-")

Is the entity without descendants in the specified hierarchy?

Parameter|Type|Description
:--------|:---|:----------
**[Entity](./Org.OData.Aggregation.V1.xml#L307:~:text=<Function%20Name="-,isleaf,-")**|EntityType?|**Binding parameter**
[Hierarchy](./Org.OData.Aggregation.V1.xml#L308:~:text=<Function%20Name="-,isleaf,-")|[HierarchyQualifier](#HierarchyQualifier)|
[&rarr;](./Org.OData.Aggregation.V1.xml#L309:~:text=<Function%20Name="-,isleaf,-")|Boolean?|
...
## <a name="AvailableOnAggregatesType"></a>[AvailableOnAggregatesType](./Org.OData.Aggregation.V1.xml#L315:~:text=<ComplexType%20Name="-,AvailableOnAggregatesType,-")


Property|Type|Description
:-------|:---|:----------
[RequiredProperties](./Org.OData.Aggregation.V1.xml#L316:~:text=<ComplexType%20Name="-,AvailableOnAggregatesType,-")|\[PropertyPath\]|Properties required to apply this action or function

## <a name="NavigationPropertyAggregationCapabilities"></a>[NavigationPropertyAggregationCapabilities](./Org.OData.Aggregation.V1.xml#L321:~:text=<ComplexType%20Name="-,NavigationPropertyAggregationCapabilities,-"): [NavigationPropertyRestriction](Org.OData.Capabilities.V1.md#NavigationPropertyRestriction) *(Deprecated)*
...
## <a name="CustomAggregateType"></a>[CustomAggregateType](./Org.OData.Aggregation.V1.xml#L339:~:text=<ComplexType%20Name="-,CustomAggregateType,-") *(Deprecated)*
